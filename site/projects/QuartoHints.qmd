...
Think of a **Quarto document** (`.qmd`) as a command center. You write commands and prose, then render the file, and an HTML (or PDF, Word, etc.) output file is created according to your commands.[^thanks]
