...
2.  Give an equation of a line with slope 4 that passes through the point (2,5).
...
3.  For the function $f(x) = x^2$, what is the slope of the line that passes through the function at $x=3$ and $x=4$.
...
4.  For the function $f(x) = x^2$, what is the slope of the line that passes through the function at $x=3$ and $x=3.1$. 
...
5.  For the function $f(x) = x^2$, what is the slope of the line that passes through the function at $x=3$ and $x=3.01$. 
...
6.  For the function $f(x) = x^2$, guess a value for the slope of the line that is tangent to the function at $x=3$ (we don't have two points anymore). 
