...
- Download [this file](../projects/m119-docs/ChainRule_comparison.pdf){target="_blank"} and complete the exercises. 
...
\begin{aligned}
f'(x) &= g'(h(x))h'(x) \\
      &= \frac{1}{2}(h(x))^{-1/2}(4e^x + 14x) \\
      &= \frac{1}{2}(4e^x + 7x^2)^{-1/2}(4e^x + 14x)
\end{aligned}
$$.
...
$$
\begin{aligned}
\frac{df}{dx}(x) &= \left(\frac{d}{dx}(x^2 - 1)\right)(-x^3 - 5x + 2) + (x^2 - 1)\frac{d}{dx}(-x^3 - 5x + 2) \\
&= (2x)(-x^3 - 5x + 2) + (x^2 - 1)(-3x^2 - 5) \\
&= -5x^4 - 12x^2 + 4x + 5
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{dh}{dx}(x) &= \frac{\left(\frac{d}{dx}(-2x^2 + x + 4)\right)(x^2 + 4x - 1) - (-2x^2 + x + 4)\frac{d}{dx}(x^2 + 4x - 1)}{(x^2 + 4x - 1)^2} \\
&= \frac{(-4x + 1)(x^2 + 4x - 1) - (-2x^2 + x + 4)(2x + 4)}{(x^2 + 4x - 1)^2} \\
&= \frac{-9x^2 - 4x - 17}{(x^2 + 4x - 1)^2}
\end{aligned}
$$

$$
\begin{aligned}
\frac{dg}{dx}(x) &= \frac{\left(\frac{d}{dx}(1-2x)(x+4)\right)(x^2 + 3x - 1) - (1-2x)(x+4)\frac{d}{dx}(x^2 + 3x - 1)}{(x^2 + 3x - 1)^2} \\
&= \frac{\left((\diff{}{x}(1-2x))(x+4) + (1-2x)\diff{}{x}(x+4)\right)(x^2 + 3x - 1) - (1-2x)(x+4)(2x + 3)}{(x^2 + 3x - 1)^2} \\
...
$$
\begin{aligned}
r_i(A, b, k; t_i, c_i) &= c_i - f(t_i; A, b, k) \\
                       &= c_i - (Ae^{bt_i} + k) \\
                       &= c_i - Ae^{bt_i} - k.
\end{aligned}
$$
