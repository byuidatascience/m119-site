...
```mathematica
Solve[{(1/2)*(x + y) == 2, (1/12)*(x - y)^2 == 3, x < y}, {x, y}]
```
...
Solving the system $a+b=5.4$ and $a-b=-\sqrt{122.4}$:
- Adding: $2a = 5.4 - \sqrt{122.4}$, so $a = 2.7 - \frac{\sqrt{122.4}}{2} \approx -2.8318$
- Substituting: $b = 5.4 - a = 2.7 + \frac{\sqrt{122.4}}{2} \approx 8.2318$

Using Mathematica to solve:

```mathematica
Solve[{(1/2)*(a + b) == 2.7, (1/12)*(a - b)^2 == 10.2, a < b}, {a, b}]
```

Or with numerical output:

```mathematica
NSolve[{(1/2)*(a + b) == 2.7, (1/12)*(a - b)^2 == 10.2, a < b}, {a, b}]
```
