...
$$
\begin{aligned}
\ell_2 &= \ell_2(a_1, a_2;\, \mathbf{t}, \mathbf{y}) \\
       &= 44\ln\left(\frac{1}{\sqrt{2\pi}}\right) + \sum_{i=1}^{44} \left(-\frac{1}{2}(y_i - 100 - a_1 t_i - a_2 t_i^2)^2\right).
\end{aligned}
$$
...
- [Partial derivatives of loglikelihood for f6](../projects/m119-docs/PDloglikelihoodFn6.html).
...
![Curve y = 8/x with right triangle](../assets/uploads/Class/8overx.png)
...
You will be working together to revisit Task 1 and complete part of Task 2 for [Project 2](../projects/unit2.html).  The prep for today asked you to watch some videos related to $f_2$.
...
5.  Adapt the inputs vector above to make a guess for what you think is the best value for $a_1$. How did you decide on that value?
...
6. Use uniroot to find where the derivative of the loglikelihood function is equal to zero.
