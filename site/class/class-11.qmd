...
2. Suppose $f(x;a,b) = a+b e^{x}$. If $f(0)=7$, then what must $a$ equal?
3. Use uniroot to solve for $x$ in $7 = 5+3 e^{2 x}$. Check your solution by finding the exact solution, if possible.

4. Use uniroot to solve for $x$ in $(-13 + 2x)e^{-0.05x} = 0$. Check your solution by finding the exact solution, if possible.
