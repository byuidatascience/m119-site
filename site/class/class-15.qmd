...
- Critique the following visual fits for $f_5$.
    - ![Visual fit 1 for f5](../assets/uploads/Class/f5-fit1.png)
    - ![Visual fit 2 for f5](../assets/uploads/Class/f5-fit2.png)
...
\begin{aligned}
y - \hat{y} &= y_3 - g(x_3) \\
            &= y_3 - \bigl(c + bx_3 + a\ln(4x_3)\bigr) \\
            &= y_3 - c - bx_3 - a\ln(4x_3)
\end{aligned}
$$
...
- Consider the 6 functions you have been fitting in [Project Unit 1](../projects/unit1.html).
