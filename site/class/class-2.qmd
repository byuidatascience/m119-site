...
2. Install an editor to work with R (pick one):
    - [**RStudio**](https://www.rstudio.com/products/rstudio/download/){target="_blank"} — the long-standing R IDE. Course examples, screenshots, and troubleshooting assume RStudio. Setup: [Install RStudio](../projects/rstudio_install.html){target="_blank"}.
    - [**Positron**](https://positron.posit.co/){target="_blank"} — Posit's newer IDE (same company as RStudio). Similar layout, single installer, R and Python support built in. Setup: [Install Positron](../projects/positron_install.html){target="_blank"}.
