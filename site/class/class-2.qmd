...
- Skim read the [instructions for Project 1](../projects/unit1.html).
...
2. Install **[Positron](https://positron.posit.co/){target="_blank"}** — the recommended IDE for this course. It has R and Python support built in and works seamlessly with Quarto. Setup: [Install Positron](../projects/positron_install.html){target="_blank"}.
...
<details>
<summary>Note for step 2 — Setting up R in VS Code (optional, click to expand)</summary>
...
- How did installing R and Positron go? If there were any hiccups along the way, what did you do to resolve them? Did you plot a function and are you willing to share the code you used? Were there any bits of code that didn't make sense? Did you ask AI for help to plot a function and have a record of your chat history you can share?
