...
- Open the [Example Project Instructions](../projects/project1_practice.html){target="_blank"}, and briefly read Task 2 and Task 3.
...
#### Summary Plots
We'll spend some time today in class discussing the [Example Project](../projects/project1_practice.html). Here's a quick snippet of code to draw the histogram representing the percent intensity of 202 bulbs after about 2100 hours.  
