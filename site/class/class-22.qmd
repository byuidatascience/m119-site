...
- Using your sketches of the derivatives of each of the six function in [this file](../projects/m119-docs/DerivativeGraphs.pdf){target="_blank"}, sketch the second derivative of each function. Remember the second derivative is the derivative of the first derivative function.

## More Derivative Practice 
- Download [this file](../projects/m119-docs/DerRules_table.pdf){target="_blank"} and complete the exercises.
...
- Review this [example of a written solution](../projects/m119-docs/project2_bmw.html){target="_blank"} for the loglikelihood calculation when using the model $f_1$. *Note this example solution is also posted in Canvas in the Additional Resources module.*
...
[Derivative Rules](../projects/m119-docs/119ReferenceSheet.html){target="_blank"}
...
2. Use the information about $f$ and $f'$ in the table and $g$ to find each of the following values.
    ...
    ![Chain rule exercise](../assets/uploads/Class/chain_rule_exercise.png)
...
![Second derivative exercise](../assets/uploads/Class/Second-Derivative-Exercise.png)
