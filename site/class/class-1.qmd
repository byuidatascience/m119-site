...
<!-- TODO: add the new course QR code here, e.g.
![Math 119 course QR code](../assets/uploads/Class/NEW-QR.png){height="100px"}
-->
...
1. Course Introduction and [Syllabus](https://byui.instructure.com/courses/425166/assignments/syllabus){target="_blank"}.
    - Are you in the right class?
    - [Weekly rhythm](https://byui.instructure.com/courses/425166/pages/math-119-weekly-rhythm){target="_blank"}, what should I be doing between class? 
