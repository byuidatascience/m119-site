...
> Download [this file](../projects/m119-docs/DerivativeGraphs.pdf){target="_blank"}. Then sketch the derivative of each function, using what you know about linear approximations (tangent lines) and the derivative.
...
2.  Let $f(x) = x^2-x$. Give an equation of the linearization of $f(x)$ at $x=-2$.
...
3.  Given the graph of a function $h(x)$ below, draw $h'(x)$.

![Draw the derivative](../assets/uploads/Class/Draw-Derivative.png)
...
![Desmos graph](../assets/uploads/Class/Desmos-Graph-Together.png)
