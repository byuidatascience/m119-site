...
Review page 1-3 in this [summary of solving equations](../projects/m119-docs/EquationSolvingStrategies_kelly.pdf){target="_blank"} compiled by my colleague Kelly MacArthur. Then complete as many of these as you can, with the goal of having something you can share with your team in class.
...
2. In R, plot the function $f(x) = x^2$ for $-2\leq x\leq 5$.

3. In R, construct a graph of $\ds f(x) = \begin{cases}2x&x<1\\3&x\geq 1\end{cases}$

4. What is the difference between a power function and an exponential function?
