...
- Begin Project 1 Task 1
    - Read each of the following.
        - [Specs](../projects/index.html){target="_blank"}
        - [Spec Details](../projects/specs_detail.html){target="_blank"}
        - [Project 1 Task 1 Instructions](../projects/unit1.html){target="_blank"}
...
- Render the document (Render button, top toolbar), and verify you can get HTML output.
    - Typing Math
...
[Project 1](../projects/index.html){target="_blank"}
