...
For our next Unit, the reading as well as many practice exercises appear in the document [Rectangles, Targets, and Sums](../projects/probability.html){target="_blank"} 
...
$$
\begin{aligned}
\bar x &= (2)\frac{3}{15} + (-6)\frac{5}{15} + (4)\frac{7}{15} \\
       &= \frac{(2)3 + (-6)5 + (4)7}{15} \\
       &= \frac{4}{15}.
\end{aligned}
$$
...
As you work through the problems below, please refer to <../projects/probability.html> as needed. 
...
Let's examine the 3 pmfs we explored above. The draw_pmf function is provided at the start of the reading in <../projects/probability.html>.
...
1. Consider the vector of integers c(2,2,2,3,3,5,5,5,5,7,8,8,9,9,9). Find the mean of the values by summing the values and then dividing by the number of values.
...
2. Use the values vector c(2,3,5,7,8,9) and frequencies vector c(3,2,4,1,2,3) to compute the mean of integers.
...
3. Use the values vector c(2,3,5,7,8,9) and proportions vector c(3/15,2/15,4/15,1/15,2/15,3/15) to compute the mean of integers.
...
4. Construct your own vector, and write code that computes the mean of the values in the vector using each of the 3 methods in this section.
...
To use the function draw_pmf(x,p), you'll have to copy the code <../projects/probability.html>.
