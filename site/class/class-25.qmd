...
Open [Project 2 instructions](../projects/unit2.html).
...
Download the worksheet and run it in RStudio: **[visualizing_derivatives.qmd](../assets/docs/visualizing_derivatives.qmd)**
...
**Draw first, then run the code.** The whole point is to *predict* the shape of $f'$ and $f''$ from the shape of $f$ — running the cells before sketching defeats the exercise. Open the file in RStudio, follow the instructions in the document, and run each step's cell only after you've put pencil to paper.
